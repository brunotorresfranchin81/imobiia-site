    ...
    <div>
      <section className="bg-preto">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
          <h1 className="max-w-2xl font-heading text-4xl font-bold text-branco sm:text-6xl">
          ...
          <p className="mt-4 max-w-xl font-sans text-base text-cinza-100">
            Wagner Sena, CRECI 067.623. Negociação direta, sem enrolação.
          </p>
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              href="/imoveis"
              className="inline-flex h-14 items-center rounded-md bg-dourado-600 px-8 font-sans text-base font-semibold text-preto transition-colors duration-rapida hover:bg-dourado-700"
            >
              Ver Imóveis
            </Link>
            <a
